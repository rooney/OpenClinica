     ...
     <div class="oc_nav">
        ...
        <!-- Logo -->
            ...
            <div id="UserInfo">
                <div id="userDropdown">
                    <ul>
                        <li><a href="${urlPrefix}UpdateProfile"><b><c:out value="${userBean.name}" /></b> (<c:out value="Data Manager" /> )<li><a href="${urlPrefix}UpdateProfile"><b><c:out value="${userBean.name}" /></b> (<c:out value="Data Manager" /> )<span class="icon icon-caret-down white"></span></a></a>
