...
<c:if test="${displayItem.data.id > 0 && section.eventCRF.stage.doubleDE_Complete && displayItem.metadata.showItem && displayItem.metadata.sdvRequired && (userRole.monitor || userRole.coordinator)}">
