...
public class PformSubmissionService {
    ...
    public Errors saveProcess(String body, String studySubjectOid, Integer studyEventDefnId, Integer studyEventOrdinal, CRFVersionBean crfVersion, Locale locale)
        ...
        if (studyEventBean.isActive()
            ...
            if (crfVersion.getXform() != null && !crfVersion.getXform().equals(""))
                errors = readDownloadFileNew(body, errors, studyBean, studyEventBean, studySubjectBean, studyEventDefinitionBean, crfVersion, locale, userAccountBean);
            else
                errors = readDownloadFile(body, errors, studyBean, studyEventBean, studySubjectBean, studyEventDefinitionBean, locale, userAccountBean);
     ...
     * @throws Exception
     */
    private Errors readDownloadFile(String body, Errors errors, StudyBean studyBean, StudyEventBean studyEventBean, StudySubjectBean studySubjectBean, StudyEventDefinitionBean studyEventDefinitionBean, Locale locale, UserAccountBean userAccountBean) throws Exception {
     ...
     * @throws Exception
     */
    private Errors readDownloadFileNew(String body, Errors errors, StudyBean studyBean, StudyEventBean studyEventBean, StudySubjectBean studySubjectBean, StudyEventDefinitionBean studyEventDefinitionBean, CRFVersionBean crfVersion, Locale locale, UserAccountBean userAccountBean) throws Exception {
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
        DocumentBuilder db = dbf.newDocumentBuilder();
        InputSource is = new InputSource();
        is.setCharacterStream(new StringReader(body));
